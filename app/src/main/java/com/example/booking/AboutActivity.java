    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_profile:
                Intent w= new Intent(AboutActivity.this,Profile.class);
                w.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(w);
                break;
            case R.id.nav_myReservation:
                Intent s= new Intent(AboutActivity.this,MyReservation.class);
            ...
            case R.id.nav_contact:
                ...
                break;
            case R.id.nav_logut:
                Intent l= new Intent(AboutActivity.this,Login.class);
